...
import ImgCrearTicket from '../assets/ImgCrearTicket.jpg';
    ...
    const noCoti = ()=>{
      if(cotizaciones.length === 0)
        return <p 
              ...
              >
                No tienes ningun ticket registrado
                <br/>
                Para hacer un ticket ve a la pantalla principal, llena el formulario en la pestaña "Ticket"
                <img 
                  alt='' 
                  src={ImgCrearTicket} 
                  style={{
